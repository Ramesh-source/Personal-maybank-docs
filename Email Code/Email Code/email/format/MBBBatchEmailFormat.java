...
public class MBBBatchEmailFormat extends AbstractMBBEMailFormat{
	
	private static final Log _log = new Log(MBBBatchEmailFormat.class,4, "com.mbb.email.fromat");
	
	public MBBBatchEmailFormat(String eMailSubject, String eMailBody) {
